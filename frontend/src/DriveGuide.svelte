...
<style>
  ...
  :global(body) {
    background:
      radial-gradient(900px 500px at 10% -10%, rgba(139, 92, 246, 0.2), transparent 55%),
      radial-gradient(700px 400px at 100% 0%, rgba(45, 212, 191, 0.1), transparent 50%),
      var(--bg);
  ...
  .body {
    ...
    background: linear-gradient(180deg, rgba(36, 36, 58, 0.98), rgba(22, 22, 40, 0.98));
